package com.zifang.z.msg.ws.support;
 ...
 * <p>
 * 这份与 {@code z-msg-channels} 的同名类逐字相同：跨模块引 test-jar 会把 channels 的
 * 依赖拖进 ws 的测试类路径，而 ws 用的是 log4j2、那边还要排 logback——为一个 40 行的
 * 测试工具背这个不划算。两边都只读自己的日志。
 */
